...
var   redis     = require(__dirname+'/../server/node_modules/redis')
    , io        = require(__dirname+'/../server/node_modules/socket.io')
    , zookeeper = require(__dirname+'/../server/node_modules/zookeeper')
